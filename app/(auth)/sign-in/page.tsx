        ...
        <div className="w-full max-w-5xl flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="hidden md:block w-full max-w-xl">
            ...
            <div className="mt-8 text-center">
              <h2 className="text-2xl font-semibold mb-4">Transform Your Learning Journey</h2>
              <p className="text-muted-foreground">
                Experience personalized learning with AI-powered assessments and instant feedback.
              </p>
            </div>
          </div>
        </div>
