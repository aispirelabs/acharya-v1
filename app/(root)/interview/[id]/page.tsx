...
const InterviewDetails = async ({ params }: RouteParams) => {
  ...
  }[interview.level?.toLowerCase() || "beginner"] || "bg-green-100 text-green-700";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 capitalize">{interview.role} Interview</h3>
                <p className="text-gray-600 mt-1">Get ready for your interview session</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-full">
                ...
                <span className="text-gray-700 font-medium">{interview.questions?.length || 0} questions</span>
              </div>
              
              <div className="flex gap-2">
                {/* Level badge */}
                <span className={cn("px-4 py-2 rounded-full text-sm font-medium", levelBadgeColor)}>
                  {displayLevel}
                </span>
                
                {/* Type badge */}
                <span className={cn("px-4 py-2 rounded-full text-sm font-medium", typeBadgeColor)}>
                  {displayType}
                </span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">Speak clearly and at a moderate pace</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="bg-primary-100 rounded-full p-1.5 mt-1">
                    <Clock className="h-4 w-4 text-primary-600" />
                  </div>
                  <p className="text-gray-600">Take a moment to think before answering</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="bg-primary-100 rounded-full p-1.5 mt-1">
                    <Lightbulb className="h-4 w-4 text-primary-600" />
                  </div>
                  <p className="text-gray-600">Provide specific examples from your experience</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="bg-primary-100 rounded-full p-1.5 mt-1">
                    <Brain className="h-4 w-4 text-primary-600" />
                  </div>
                  <p className="text-gray-600">Be honest about your knowledge and experience</p>
                </li>
              </ul>
            </div>
            ...
            {/* Progress */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Your Progress</h4>
